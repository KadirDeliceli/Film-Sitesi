...
<body>
    ...
    <div class="header">
        ...
        <div class="overlay"></div> <input type="text" id="arama" placeholder="arama yapınız lütfen!!!! Cloud Computing" onkeyup="filmAra()">
    ...
    <div class="film-container">
        ...
        $kac = 10; //bir sayfada kaç tane film gösterilecğini belirliyoruz
        $sayfa = $_GET["sayfa"];
        ...
        $Sorgu = mysqli_query($VeritabaniBaglantisi, "SELECT * FROM filmler  ORDER BY id ASC LIMIT $sayfa1 , $kac ");
        if ($Sorgu) {
